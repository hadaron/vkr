...
<main>
    <section>
        ...
        <article class="BlockCard">
            <figure>
                <img src="{{asset('svg/logo-card.svg')}}">
                <figcaption>Карта выгодных<br> покупок</figcaption>
                <figcaption class="Number">9884 2372 7432 69</figcaption>
            </figure>
        </article>
    </section>
</main>
<footer>
    ...
    @else
        <section>
            <a class="FooterButton1" href="{{ url('admin') }}">Администрирование</a>
            {{--            <a class="FooterButton2" href="{{ route('logout')}} ">Выйти</a>--}}
        </section>
    @endguest
    <article>
